...
<body class="single-page home-page" data-spy="scroll" data-target="#scroll-list-home" data-offset="30">
    ...
    <div class="supreme-container">
        ...
        <!-- SWIPER -->
        <div class="swiper-container hero-slider" id="home-header">
        ...
        <!-- SERVICES -->
        <div class="our-services" id="home-services">
        ...
        <!-- WELCOME -->
        <div class="home-page-welcome" id="home-welcome">
            <div class="container">
                <div class="row">
        ...
        <!-- COMPANY BLOGS -->
        <div class="home-page-blogs" id="home-blogs">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        </div>
