                    ...
                    <div class="box">
                        <div class="content">
                            ...
                            <div class="form loginBox">    
                                ...
                                <button class="btn btn-default btn-login" onclick="login()">Login</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="content registerBox" style="display:none;">
                            <div class="form">    
                                ...
                                <input id="email" class="form-control" type="email" placeholder="Email" name="email" onblur="confirmEmail()">
                                <p id="invalidEmail">Email already exists.*</p>
                                <input id="number" class="form-control" type="text" placeholder="Mobile number" name="number">
                                <input id="username" class="form-control" type="text" placeholder="Username" name="username" onblur="confirmUserName()">
                                <p id="invalidUname">Username already taken.*</p>
                                ...
                                <button id="registerBtn" class="btn btn-default btn-register" onclick="registerAcc()">Create Account </button>
                            </div>
                        </div>
                    </div>
                </div><!-- .modal-body -->
