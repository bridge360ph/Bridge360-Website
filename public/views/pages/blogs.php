                    ...
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                ...
                                <li class="current-menu-item"><a href="blogs.html">Blogs</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                        <div class="foot-contact">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i><span>+63 998 9925241</span></li>
                                <li><i class="fa fa-envelope"></i><span>iambridge360@gmail.com</span></li>
                                <li><i class="fa fa-map-marker"></i><span>Unit 25D Zeta II Bldg., 191 Salcedo St, Legaspi Village, Makati City 1229</span></li>
                            </ul>
                        </div><!-- .foot-contact -->
